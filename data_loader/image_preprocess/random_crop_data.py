...
import cv2
import numpy as np
from data_loader.image_preprocess.iaa_augment import draw_box_on_img
...
class EastRandomCropData(object):
    ...
    def __init__(self, config):
        self.size = config.random_crop_size
        self.max_tries = config.random_crop_max_tries
        self.min_crop_side_ratio = config.random_crop_min_crop_side_ratio
        self.require_original_image = config.random_crop_require_original_image
        self.keep_ratio = config.random_crop_keep_ratio
